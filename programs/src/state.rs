...
pub const CONFIG_SEED: &[u8] = b"annaumixyz-config";

/// PDA seed for the program-owned vault that custodies the 18.9M mineable
/// supply.
pub const VAULT_SEED: &[u8] = b"annaumixyz-vault";

/// 21,000,000 ANX (6 decimals) = 21,000,000,000,000 base units.
pub const TOTAL_SUPPLY_BASE: u64 = 21_000_000 * 1_000_000;

/// 2,100,000 ANX (10%, premine to treasury).
pub const PREMINE_BASE: u64 = 2_100_000 * 1_000_000;

/// 18,900,000 ANX (90%, mineable). Equals `TOTAL_SUPPLY_BASE - PREMINE_BASE`.
pub const MINEABLE_BASE: u64 = TOTAL_SUPPLY_BASE - PREMINE_BASE;

/// 25 ANX initial block reward, in base units.
