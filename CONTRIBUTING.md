...
- **Don't break the supply curve.** 21M total / 18.9M mineable / halving every 378k blocks at 25 ANX/block initial reward is locked. Changes that alter these numbers won't be merged.
...
# Clone + build
git clone https://github.com/<your-fork>/annaumixyz.git
cd annaumixyz
yarn install
anchor build
...
# Run tests
cargo test -p annaumixyz                # schedule math
