...
import { fetchConfig, getProgram, type AnnaumixyzConfig } from "./program";
...
export function App() {
  ...
  const [config, setConfig] = useState<AnnaumixyzConfig | null>(null);
  ...
  return (
    <div className="container">
      <div className="header">
        <div className="brand">
          <img src="/logo.png" alt="Annaumixyz" className="brand-logo" />
          <div className="brand-text">
            Annaumixyz
            <span className="ticker">$ANX</span>
          </div>
        </div>
        <WalletMultiButton />
      </div>
      ...
      <p className="tagline">
        ...
        click Start Mining, earn $ANX. Solving runs in your browser.
      </p>
      ...
      <div className="panel">
        ...
        {wallet.publicKey ? (
          <div className="stat-grid">
            ...
            <div className="stat">
              <div className="label">ANX balance</div>
              <div className="value">
            ...
            {config && wallet.publicKey ? (
              <a
                href={`https://explorer.solana.com/address/${import.meta.env
                  .VITE_PROGRAM_ID || "ZKGMUfxiRCXFPnqz9zgqAnuqJy15jk7fKbR4o6FuANX"}?cluster=${
                  cluster
                }`}
                target="_blank"
                rel="noreferrer"
