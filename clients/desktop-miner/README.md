# Annaumixyz Desktop Miner

Native Tauri 2 app for mining Annaumixyz ($ANX) on macOS, Windows, and Linux. Single binary, built-in wallet, no extension required.
