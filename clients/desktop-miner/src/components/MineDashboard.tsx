    ...
    <div className="card-hero">
      <div className="row-between" style={{ alignItems: "flex-start" }}>
        <div style={{ minWidth: 0 }}>
          ...
          <p className="muted" style={{ marginTop: 8, maxWidth: 480, fontSize: 13.5 }}>
            {running
              ? "Your CPU is racing the network. Every solved block credits 25 ANX to this wallet."
              : miningOpen
                ? "Press start. The protocol pays 25 ANX per block to the first valid solution it sees."
      ...
      >
        ...
        <Stat
          ...
          value={formatEqm(earnedBase, ANX_DECIMALS)}
          unit="ANX"
    ...
    <div className="card stack">
      ...
      <div className="row" style={{ gap: 32 }}>
        ...
        <div>
          ...
          <div className="stat-num" style={{ fontSize: 22 }}>
            {balances ? formatEqm(balances.eqm_base, ANX_DECIMALS) : "—"}
          </div>
        </div>
      </div>
  ...
  return (
    <div className="card stack">
      ...
      <Row
        ...
        v={
          <span className="mono">
            {formatEqm(program.epoch_reward, ANX_DECIMALS)}{" "}
            <span className="dim">ANX</span>
          </span>
        }
      />
      <Row
