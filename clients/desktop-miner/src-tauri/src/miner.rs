...
use annaumixyz::state::{CONFIG_SEED, AnnaumixyzConfig, VAULT_SEED};
...
fn fetch_config(rpc: &RpcClient, config_pda: &Pubkey) -> anyhow::Result<AnnaumixyzConfig> {
