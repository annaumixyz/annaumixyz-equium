      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-12 gap-10">
          ...
          <FooterCol
            title="Build"
            items={[
              { label: "GitHub", href: "https://github.com/annaumixyz/annaumixyz" },
              {
                label: "CLI miner",
                href: "https://github.com/annaumixyz/annaumixyz#run-the-cli-miner",
              },
              {
                label: "Contributing",
                href: "https://github.com/annaumixyz/annaumixyz/blob/master/CONTRIBUTING.md",
              },
              { label: "License", href: "https://github.com/annaumixyz/annaumixyz/blob/master/LICENSE" },
            ]}
          />
          <FooterCol
            title="Network"
            items={[
              { label: "X / Twitter", href: "https://x.com/Annaumixyz" },
              {
                label: "Solana Explorer",
                href: "https://explorer.solana.com/address/ZKGMUfxiRCXFPnqz9zgqAnuqJy15jk7fKbR4o6FuANX",
              },
            ]}
          />
        </div>
        ...
        <div className="mt-14 pt-6 border-t border-[var(--color-border)] flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
          <p className="text-[12px] font-mono text-[var(--color-fg-dim)]">
            ...
            ZKGMUfxiRCXFPnqz9zgqAnuqJy15jk7fKbR4o6FuANX
          </p>
          <p className="text-[11px] text-[var(--color-fg-faint)]">
            Annaumixyz isn't an investment. It's a fair-launched experiment in
