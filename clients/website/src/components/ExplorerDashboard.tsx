...
interface Props {
  initialState: AnnaumixyzState | null;
...
export function ExplorerDashboard({
  ...
  const [state, setState] = useState<AnnaumixyzState | null>(initialState);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-[15px] text-[var(--color-fg-dim)]">
            Real-time state of the Annaumixyz protocol.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <StatCard
          label="Epoch reward"
          value={`${formatEqm(state.epochReward)} ANX`}
          accent="gold"
        />
        <StatCard
          label="Empty rounds"
        ...
        <div className="rounded-3xl border border-[var(--color-border)] bg-[var(--color-panel)] p-7">
          ...
          <div className="mt-5 flex items-end justify-between">
            ...
            <div className="text-right">
              ...
              <div className="text-[18px] font-mono font-semibold">
                {formatEqm(state.epochReward / 2)} ANX
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="rounded-3xl border border-[var(--color-border)] bg-[var(--color-bg-elev)] p-7">
        ...
        <div className="grid md:grid-cols-2 gap-x-8 gap-y-2.5 font-mono text-[12px]">
          <AddrRow label="Program" value="ZKGMUfxiRCXFPnqz9zgqAnuqJy15jk7fKbR4o6FuANX" />
        ...
        return (
          ...
          >
            ...
            <div className="col-span-3 md:col-span-2">
              ...
              <div className="text-[14px] font-mono font-bold text-[var(--color-gold)]">
                {formatEqm(row.totalRewardBase)} ANX
              </div>
            </div>
