...
const ITEMS = [
  {
    q: "Will I make money mining ANX?",
    a: "Maybe, maybe not. Annaumixyz is an experiment in fair-launch distribution rather than a yield product. The protocol issues 25 ANX per block to whoever submits the first valid solution, but the market value of those tokens is determined by demand on the open market and is not guaranteed.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Mint authority is revoked at the SPL Token level before the public launch. After that, no additional ANX can ever be created by anyone — the cap is enforced by the runtime, not by promises in protocol code.",
  },
  {
    q: "Where is the source code?",
    a: "The full protocol, miners, and website are open source under Apache-2.0 at github.com/annaumixyz/annaumixyz. The on-chain program is roughly 1,000 lines of Rust. You can audit it, fork it, or run your own miner against it.",
  },
  {
    q: "When does mainnet launch?",
    a: "Mainnet is live. The program is deployed at ZKGMUfxiRCXFPnqz9zgqAnuqJy15jk7fKbR4o6FuANX and the ANX mint is 1MhvZzEe8gQ8Rb9CrT3Dn26Gkn9QRErzLMGkkTwveqm. Follow @Annaumixyz for protocol updates.",
  },
];
