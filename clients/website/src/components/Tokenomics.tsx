        ...
        <div className="mt-16 grid md:grid-cols-12 gap-4">
          ...
          <div className="md:col-span-5 rounded-3xl border border-[var(--color-border)] bg-[var(--color-panel)] p-8">
            ...
            <div className="space-y-2 font-mono text-[13px]">
              {[
                { era: "Era 1", reward: "25 ANX", year: "Year 0" },
                { era: "Era 2", reward: "12.5 ANX", year: "Year ~0.7" },
                { era: "Era 3", reward: "6.25 ANX", year: "Year ~1.4" },
                { era: "Era 4", reward: "3.125 ANX", year: "Year ~2.1" },
          ...
          <Prop
            ...
            body="Mint authority is revoked at launch, so no future inflation is possible. This is enforced at the SPL Token program level, not by Annaumixyz's own program logic."
          />
          <Prop
