...
import { detectTokenProgram, fetchConfig, getProgramAnchorlike, type AnnaumixyzConfig } from "@/lib/program";
...
function LiveStats({
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
      ...
      <BigStat
        label="Earned"
        value={`${formatEqm(stats.earnedBase)} ANX`}
        accent="mint"
      />
      <BigStat
        label="Status"
...
const WORKER_COUNT_KEY = "annaumixyz:browser-workers";
