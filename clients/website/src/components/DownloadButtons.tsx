...
const RELEASES_BASE =
  "https://github.com/annaumixyz/annaumixyz/releases/latest/download";
    ...
    switch (platform) {
      ...
      case "macos-x64":
        return {
          ...
          href: `${RELEASES_BASE}/Annaumixyz-Miner.dmg`,
        };
      case "windows":
        return {
          label: "Download for Windows",
          tag: "Windows 10/11 · .msi",
          href: `${RELEASES_BASE}/Annaumixyz-Miner.msi`,
        };
      case "linux":
        return {
          label: "Download for Linux",
          tag: "x86_64 · .AppImage",
          href: `${RELEASES_BASE}/Annaumixyz-Miner.AppImage`,
        };
      default:
        return null;
    }
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <PlatformLink
          ...
          file="Annaumixyz-Miner-aarch64.dmg"
        />
        <PlatformLink
          label="macOS · Intel"
          file="Annaumixyz-Miner-x64.dmg"
        />
        <PlatformLink label="Windows · x64" file="Annaumixyz-Miner.msi" />
        <PlatformLink label="Linux · AppImage" file="Annaumixyz-Miner.AppImage" />
      </div>
