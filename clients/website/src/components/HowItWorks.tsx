      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-4">
          ...
          <StepCard
            num="03"
            title="Earn"
            body="Submit the solution as a Solana transaction. The on-chain program verifies it and transfers 25 ANX to your wallet. Rounds close roughly every minute."
          />
        </div>
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-4">
          ...
          <InfoCallout
            ...
            body="The reward starts at 25 ANX per block and halves at fixed intervals: 12.5, 6.25, and so on. The emission curve mirrors Bitcoin, mapped to roughly one-minute blocks, so 99% of supply is produced within the first decade."
          />
        </div>
      </div>
    </section>
