  ...
  const copy =
    stage === "not-initialized"
      ? {
          ...
          body: (
            <>
              The Annaumixyz program is live on Solana mainnet at{" "}
              <code className="font-mono text-[12.5px] text-[var(--color-teal)]">
                ZKGM…uANX
              </code>{" "}
              and the build is{" "}
              <a
                href="https://verify.osec.io/status/ZKGMUfxiRCXFPnqz9zgqAnuqJy15jk7fKbR4o6FuANX"
                target="_blank"
