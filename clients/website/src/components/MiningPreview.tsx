          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl border border-[var(--color-border-bright)] bg-[var(--color-bg)] overflow-hidden shadow-2xl">
              ...
              <div className="text-[12px] leading-[1.7] font-mono p-5 overflow-hidden">
                <TermLog>annaumixyz-miner online</TermLog>
                <TermLog>{"  miner    "}<Teal>AgbS…AANX</Teal></TermLog>
                <TermLog>{"  program  "}<Teal>ZKGM…uANX</Teal></TermLog>
                <TermLog>{"  rpc      "}<Dim>https://api.mainnet-beta.solana.com</Dim></TermLog>
                <div className="h-3" />
                <TermLog><Bold>round #18</Bold>{"   reward 25 ANX   target 0x40ffff…"}</TermLog>
                ...
                <TermLog>{"  "}<Sage>✓ MINED!</Sage>{"   "}<Bold>+25 ANX</Bold>{"   try #4   "}<Gold>1.6 H/s</Gold></TermLog>
                <TermLog>{"    "}<Dim>sig YrgmXW…AvNCGY</Dim></TermLog>
                <div className="h-3" />
                <TermLog><Dim>total mined</Dim>{"  "}<Bold>25 ANX</Bold>{"  ·  "}<Dim>blocks</Dim>{"  "}<Bold>1</Bold>{"  ·  "}<Dim>uptime</Dim>{"  "}<Bold>0:08</Bold></TermLog>
              </div>
            </div>
          </div>
        </div>
