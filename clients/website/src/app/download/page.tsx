...
export const metadata = {
  title: "Download Annaumixyz Miner",
  description:
    "Three ways to mine Annaumixyz ($ANX): native desktop installers for macOS/Windows/Linux, a browser miner, and a Rust CLI reference miner. Same protocol, same on-chain output.",
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-3 mb-12">
            <Chooser
              kicker="Browser"
              title="No install"
              body="One click on annaumixyz.xyz/mine. Built-in wallet, our RPC proxy. Best for casual mining and trying things out."
              href="/mine"
              cta="Open in browser →"
            />
            <Chooser
                ...
                <ol className="list-decimal pl-6 space-y-1.5 text-[14px] leading-[1.6] text-[var(--color-fg-dim)] mb-3">
                  ...
                  <li>
                    ...
                    <code className="font-mono text-[12.5px] text-[var(--color-teal)]">
                      Get-FileHash Annaumixyz-Miner.msi
                    </code>{" "}
                    in PowerShell.
                  </li>
                </ol>
              ...
              <Note title="How it works">
                <ol className="list-decimal pl-6 space-y-2 text-[14.5px] leading-[1.6] text-[var(--color-fg-dim)]">
                  ...
                  <li>
                    ...
                    directly to Solana. Each block credits 25 ANX to your wallet.
                  </li>
                </ol>
              </Note>
          ...
          <section id="cli-miner" className="mt-16 scroll-mt-32">
            ...
            <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-elev)] p-6 space-y-4">
              <div>
                ...
                <pre className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] p-4 overflow-x-auto font-mono text-[12.5px] leading-[1.7] text-[var(--color-fg-soft)]">{`git clone https://github.com/annaumixyz/annaumixyz
cd annaumixyz/clients/cli-miner
cargo build --release`}</pre>
              ...
              <div>
                ...
                <pre className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] p-4 overflow-x-auto font-mono text-[12.5px] leading-[1.7] text-[var(--color-fg-soft)]">{`./target/release/annaumixyz-miner \\
  ...
  --keypair ~/.config/solana/id.json`}</pre>
              ...
              <div className="pt-2 border-t border-[var(--color-border)]">
                <a
                  href="https://github.com/annaumixyz/annaumixyz/tree/master/clients/cli-miner"
                  target="_blank"
