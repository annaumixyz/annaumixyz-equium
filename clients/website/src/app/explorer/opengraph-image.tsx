...
export const alt = "Annaumixyz Explorer — live blocks and miners";
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <div style={{ fontSize: 28, fontWeight: 900 }}>Annaumixyz</div>
              <div
                style={{
                  fontSize: 13,
                  color: "#e85a8d",
...
function formatMined(base: number): string {
  ...
  if (eqm < 1000) return `${eqm.toFixed(0)} ANX`;
  if (eqm < 1_000_000) return `${(eqm / 1000).toFixed(1)}k ANX`;
  return `${(eqm / 1_000_000).toFixed(2)}M ANX`;
}
