...
export const metadata = {
  title: "Mine $ANX",
  description:
    "Mine $ANX in your browser. Generate a wallet, press start, your machine earns block rewards. No install. Mobile-friendly. Fair-launched on Solana.",
  openGraph: {
    title: "Mine $ANX in your browser",
    description:
