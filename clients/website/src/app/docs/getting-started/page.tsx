...
export const metadata = {
  title: "Getting started · Annaumixyz docs",
  description:
    "Set up the Annaumixyz browser miner or desktop app: generate a wallet, fund it with SOL, and start producing blocks.",
};
  ...
  return (
    <DocsLayout>
      <DocTitle
        ...
        lede="Annaumixyz has two reference miners: a browser-based one at annaumixyz.xyz/mine and a native desktop app. Both produce identical on-chain transactions; the desktop app is faster because it runs natively."
      />
      ...
      <Callout tone="warn" title="Write down your secret key">
        Annaumixyz does not run a custody service. There is no password reset, no
      ...
      <OL>
        ...
        <li>
          Each successful block credits 25 ANX to your wallet directly. You
      ...
      <P>
        Both wallets include a Send action that supports SOL and ANX. ANX
        ...
        at send time. If the recipient has never held ANX, the sender pays a
      ...
      <P>
        ...
        <a
          href="https://github.com/annaumixyz/annaumixyz"
          target="_blank"
          rel="noreferrer noopener"
          className="text-[var(--color-rose)] hover:underline"
        >
          github.com/annaumixyz/annaumixyz
        </a>
        . The CLI reference miner is the shortest path to a headless setup:
      </P>
      <Pre>{`git clone https://github.com/annaumixyz/annaumixyz
