...
export const metadata = {
  title: "Tokenomics · Annaumixyz docs",
  description:
    "Annaumixyz's supply schedule, premine allocation, halving curve, and how the 21M cap is enforced on-chain.",
};
  ...
  return (
    <DocsLayout>
      <DocTitle
        ...
        lede="Annaumixyz has a fixed 21,000,000 token supply, split 10/90 between a premine and the mineable pool. The mineable portion is released via a Bitcoin-style halving curve. The cap is enforced at the SPL Token level by revoking mint authority before launch."
      />

      <H2 id="mint-address">Mint address</H2>
      <P>
        The official ANX token mint on Solana mainnet is below. Verify this
        before buying on any DEX — anyone can create a token called &quot;ANX&quot;
      ...
      <Callout tone="info" title="Verify before buying">
        Anyone can deploy a token called &quot;ANX&quot; on Solana. The address
      ...
      <Table
        ...
        rows={[
          ["Mineable pool", "18,900,000 ANX", "90%", "Distributed via proof-of-work, 25 ANX per block, halving every 378k blocks."],
          ["Premine", "2,100,000 ANX", "10%", "Reserved for DEX liquidity provisioning and operational expenses. No founder allocation, no team vesting."],
        ]}
      />
      ...
      <Table
        ...
        rows={[
          ["1", "25.00 ANX", "9,450,000", "9,450,000"],
          ["2", "12.50 ANX", "4,725,000", "14,175,000"],
          ["3", "6.25 ANX", "2,362,500", "16,537,500"],
          ["4", "3.125 ANX", "1,181,250", "17,718,750"],
          ["5", "1.5625 ANX", "590,625", "18,309,375"],
          ["6", "0.78 ANX", "295,313", "18,604,688"],
          ["…", "…", "…", "→ 18,900,000"],
        ]}
      />
      <P>
      ...
      <UL>
        ...
        <li>
          ...
          vault is drained, no further ANX exists.
        </li>
        <li>
          ...
          Annaumixyz's own program, can mint additional tokens after that point.
        </li>
      </UL>
      ...
      <P>
        ...
        during low-hashrate periods), its 25-ANX reward stays in the vault
      ...
      <P>
        ...
        <Code>find_program_address([&quot;annaumixyz-vault&quot;])</Code>. The
      ...
      <P>
        Annaumixyz is not designed to be a yield product. The economic model is
        deliberately simple:
      </P>
      <UL>
        <li>
          <strong>Supply schedule is fixed.</strong> 25 ANX enters the
          mineable supply each block (in expectation), halving over time.
          Nothing on the protocol side dynamically responds to market
          conditions.
        </li>
        <li>
          <strong>Demand drives price.</strong> Whatever ANX is worth in SOL
