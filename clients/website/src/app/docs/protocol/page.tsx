...
export const metadata = {
  title: "Protocol · Annaumixyz docs",
  description:
    "Annaumixyz's proof-of-work protocol: Equihash 96,5, block rounds, difficulty retargeting, halving, and the on-chain program.",
};
  ...
  return (
    <DocsLayout>
      <DocTitle
        ...
        lede="Annaumixyz is a single Solana program that runs a proof-of-work round every minute or so. Miners race to find an Equihash 96,5 solution whose hash falls under the current difficulty target. The first valid solution closes the round and mints 25 ANX to the winner."
      />
...
0       9    b"Annaumixyz-v1"           personalization
9       32   current_challenge      from AnnaumixyzConfig
41      32   miner_pubkey
73      8    block_height (LE u64)`}</Pre>
      ...
      <P>
        ...
        <Code>AnnaumixyzConfig.current_target</Code>. A solution wins if{" "}
      ...
      <P>
        Block reward starts at 25 ANX per block and halves every 378,000
      ...
      <Table
        ...
        rows={[
          [<Code key="e1">Era 1</Code>, "25 ANX", "Genesis", "0 → 9,450,000"],
          [<Code key="e2">Era 2</Code>, "12.5 ANX", "~Month 9", "9,450,000 → 14,175,000"],
          [<Code key="e3">Era 3</Code>, "6.25 ANX", "~Year 1.7", "14,175,000 → 16,537,500"],
          [<Code key="e4">Era 4</Code>, "3.125 ANX", "~Year 2.6", "16,537,500 → 17,718,750"],
        ]}
      />
      <P>
      ...
      <Table
        ...
        rows={[
          [
            <Code key="config">AnnaumixyzConfig</Code>,
            <Code key="cs">[&quot;annaumixyz-config&quot;]</Code>,
            "Round state, target, equihash params, halving counters, last winner.",
          ],
          [
            <Code key="vault">Mineable vault</Code>,
            <Code key="vs">[&quot;annaumixyz-vault&quot;]</Code>,
