...
export const metadata = {
  title: "Documentation",
  description:
    "Technical documentation for Annaumixyz: protocol design, tokenomics, mining setup, and RPC configuration.",
};
  ...
  return (
    <DocsLayout>
      <DocTitle
        ...
        title="Annaumixyz documentation"
      ...
      />
      <P>
        Annaumixyz is a CPU-mineable token on Solana with a fixed 21M supply and a
