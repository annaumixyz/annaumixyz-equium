...
export const metadata = {
  title: "RPC setup · Annaumixyz docs",
  description:
    "How to plug a free Helius RPC endpoint into the Annaumixyz desktop miner.",
};
  ...
  return (
    <DocsLayout>
      <DocTitle
        ...
        lede="The Annaumixyz desktop miner needs a Solana RPC endpoint to read on-chain state and submit mining transactions. The default public endpoint is heavily rate-limited; a free Helius key gives you 100,000 requests per day, which is more than enough for a single miner running around the clock."
      />
      ...
      <OL>
        ...
        <li>
          Open the Annaumixyz Miner desktop app, click <Code>Settings</Code> in
      ...
      <P>
        annaumixyz.xyz fronts a server-side RPC proxy with per-IP rate limits.
