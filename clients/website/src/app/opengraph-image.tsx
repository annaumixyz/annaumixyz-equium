...
export const alt = "Annaumixyz — CPU-mineable Solana token";
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <div style={{ fontSize: 30, fontWeight: 900 }}>Annaumixyz</div>
              <div
                style={{
                  fontSize: 14,
                  color: "#e85a8d",
        ...
        >
          <div style={{ display: "flex", gap: 32 }}>
            ...
            <Stat label="Block reward" value="25 ANX" color="#facc15" />
