/* @ts-self-types="./annaumixyz_wasm.d.ts" */
...
/**
 * Build the Annaumixyz I-block (`Annaumixyz-v1 || challenge || miner || height_le`).
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('annaumixyz_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
